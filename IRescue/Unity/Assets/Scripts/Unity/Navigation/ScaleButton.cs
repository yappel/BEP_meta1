// <copyright file="ScaleButton.cs" company="Delft University of Technology">
...
namespace Assets.Unity.Navigation
{
    ...
    /// <summary>
    /// This code should be coupled to the Scale button prefab
    /// </summary>
    public class ScaleButton : MonoBehaviour, IPointerClickHandler
    {
        ...
        {
            GameObject.FindObjectOfType<StateController>().ModifyScaleButtonEvent(eventData);
        }
    }
}