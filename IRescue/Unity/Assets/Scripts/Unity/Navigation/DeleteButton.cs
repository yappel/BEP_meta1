// <copyright file="DeleteButton.cs" company="Delft University of Technology">
...
namespace Assets.Unity.Navigation
{
    ...
    /// <summary>
    /// This code should be coupled to the Delete button prefab
    /// </summary>
    public class DeleteButton : MonoBehaviour, IPointerClickHandler
    {
        ...
        {
            GameObject.FindObjectOfType<StateController>().DeleteButtonEvent(eventData);
        }
    }
}