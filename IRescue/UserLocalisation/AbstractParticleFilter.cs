namespace IRescue.UserLocalisation
{
    ...
    public abstract class AbstractParticleFilter
    {
        ...
        protected AbstractParticleFilter(INoiseGenerator noiseGenerator, AbstractParticleController particleControllerX, AbstractParticleController particleControllerY, AbstractParticleController particleControllerZ, float resampleNoiseSize)
        {
        ...
        {
            this.particleControllerX.Resample();
            this.particleControllerY.Resample();
            this.particleControllerZ.Resample();
            this.noiseGenerator.GenerateNoise(this.resampleNoiseSize, this.particleControllerX);
            this.noiseGenerator.GenerateNoise(this.resampleNoiseSize, this.particleControllerY);
            this.noiseGenerator.GenerateNoise(this.resampleNoiseSize, this.particleControllerZ);
        }
