...
namespace IRescue.UserLocalisation.Particle
{
    ...
    public class ParticleFilterTest
    {
        ...
        public void Init()
        {
            ...
            {
                new Measurement<Vector3>(new Vector3(2.5f, 1.8f, 2.5f), 0.1f, 0, DistributionType.uniform)
            };
            ...
            {
                new Measurement<Vector3>(new Vector3(40f, 40f, 40f), 0.1f, 0, DistributionType.uniform)
            };
